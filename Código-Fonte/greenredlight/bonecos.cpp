...
void Bonecos::render(Camera m_camera) {
  ...
  //glm::mat4 model{1.0f};
  //model = glm::translate(model, glm::vec3(0.0f, 0.31f, 2.0f)); // reposicionar o centro
  //model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
  //model = glm::scale(model, glm::vec3(0.5f)); // destorcer objeto nas coordenadas x,y,z
  //glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &model[0][0]);
  //glUniform4f(colorLoc, color[0], color[1], color[2], 1.0f);
  //glDrawElements(GL_TRIANGLES, m_indices.size(), GL_UNSIGNED_INT, nullptr);

  glm::mat4 model{1.0f};
  model = glm::translate(model, glm::vec3(-1.75f, 0.31f, 4.0f)); // reposicionar o centro
  model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
  model = glm::scale(model, glm::vec3(0.5f)); // destorcer objeto nas coordenadas x,y,z
  glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &model[0][0]);
  glUniform4f(colorLoc, color[0], color[1], color[2], 1.0f);
  ...
  model = glm::mat4(1.0);
  model = glm::translate(model, glm::vec3(0.75f, 0.31f, 3.5f)); // reposicionar o centro
  model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
  model = glm::scale(model, glm::vec3(0.5f)); // destorcer objeto nas coordenadas x,y,z
  glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &model[0][0]);
  glDrawElements(GL_TRIANGLES, m_indices.size(), GL_UNSIGNED_INT, nullptr);
  ...
  model = glm::mat4(1.0);
  model = glm::translate(model, glm::vec3(-1.0f, 0.31f, 2.0f)); // reposicionar o centro
  model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
  model = glm::scale(model, glm::vec3(0.5f)); // destorcer objeto nas coordenadas x,y,z
  glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &model[0][0]);
  glDrawElements(GL_TRIANGLES, m_indices.size(), GL_UNSIGNED_INT, nullptr);
  ...
  model = glm::mat4(1.0);
  model = glm::translate(model, glm::vec3(1.75f, 0.31f, 2.25f)); // reposicionar o centro
  model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
  model = glm::scale(model, glm::vec3(0.5f)); // destorcer objeto nas coordenadas x,y,z
  glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &model[0][0]);
  glDrawElements(GL_TRIANGLES, m_indices.size(), GL_UNSIGNED_INT, nullptr);
  ...
  model = glm::mat4(1.0);
  model = glm::translate(model, glm::vec3(0.55f, 0.31f, 1.60f)); // reposicionar o centro
  model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
  model = glm::scale(model, glm::vec3(0.5f)); // destorcer objeto nas coordenadas x,y,z
  glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &model[0][0]);
  glDrawElements(GL_TRIANGLES, m_indices.size(), GL_UNSIGNED_INT, nullptr);
    ...
    model = glm::mat4(1.0);
  model = glm::translate(model, glm::vec3(1.6f, 0.31f, 0.5f)); // reposicionar o centro
  model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
  model = glm::scale(model, glm::vec3(0.5f)); // destorcer objeto nas coordenadas x,y,z
  glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &model[0][0]);
  glDrawElements(GL_TRIANGLES, m_indices.size(), GL_UNSIGNED_INT, nullptr);
  ...
  model = glm::mat4(1.0);
  model = glm::translate(model, glm::vec3(-1.85f, 0.31f, 0.6f)); // reposicionar o centro
  model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
  model = glm::scale(model, glm::vec3(0.5f)); // destorcer objeto nas coordenadas x,y,z
  glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &model[0][0]);
  glDrawElements(GL_TRIANGLES, m_indices.size(), GL_UNSIGNED_INT, nullptr);
