...
void Arvore::render(Camera m_camera) {
  ...
  glm::mat4 model{1.0f};
  model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f)); // reposicionar o centro
  model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0, 1, 0)); // angulo de rotação e em torno de qual eixo
